 ...
 */
function beautychef_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Beauty Chef default saturation level.
	 *
	 * @since Beauty Chef 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'beautychef_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.beautychef-front-page) .entry-title,
...
.colors-custom .beautychef-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.beautychef-front-page .panel-content .recent-posts article,
...
.colors-custom.beautychef-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Beauty Chef custom colors CSS.
	 *
	 * @since Beauty Chef 1.0
	 *
	 ...
	 */
	return apply_filters( 'beautychef_custom_colors_css', $css, $hue, $saturation );
}
